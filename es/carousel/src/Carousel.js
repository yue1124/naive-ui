...
export default defineComponent({
  ...
  setup(props) {
    ...
    const slideSizesRef = computed(() => {
      ...
      return slidesEls.map(() =>
        Object.assign(Object.assign({}, perViewSize), { [axis]: slideSize })
      )
    })
    ...
    function handleSlideResize() {
      var _a, _b
      if (autoSlideSizeRef.value) {
        ;(_b = (_a = slideSizesRef.effect).scheduler) === null || _b === void 0
          ? void 0
          : _b.call(_a)
              ...
              userWantsControl
                ? slides.map((slide, i) =>
                    h(
                      ...
                      withDirectives(
                        h(Transition, Object.assign({}, transitionProps), {
                          default: () => slide
                        }),
