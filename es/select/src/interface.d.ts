...
export declare type SelectMixedOption =
  | SelectBaseOption
  | SelectGroupOption
  | SelectIgnoredOption
...
export declare type SelectTreeMate = TreeMate<
  SelectBaseOption,
  SelectGroupOption,
  SelectIgnoredOption
>
...
export declare type SelectGroupOption =
...
export declare type SelectFallbackOption = (
  value: string & number
) => SelectOption
export declare type SelectFallbackOptionImpl = (
  value: string | number
) => SelectOption
