...
export declare function uniCalendarValidation(
  ...
  isHourDisabledRef: import('vue').ComputedRef<
    import('../../time-picker/src/interface').IsHourDisabled | undefined
  >
  isMinuteDisabledRef: import('vue').ComputedRef<
    import('../../time-picker/src/interface').IsMinuteDisabled | undefined
  >
  isSecondDisabledRef: import('vue').ComputedRef<
...
export declare function dualCalendarValidation(
  ...
  isStartHourDisabledRef: import('vue').ComputedRef<
    import('../../time-picker/src/interface').IsHourDisabled | undefined
  >
  isEndHourDisabledRef: import('vue').ComputedRef<
    import('../../time-picker/src/interface').IsHourDisabled | undefined
  >
  isStartMinuteDisabledRef: import('vue').ComputedRef<
    import('../../time-picker/src/interface').IsMinuteDisabled | undefined
  >
  isEndMinuteDisabledRef: import('vue').ComputedRef<
    import('../../time-picker/src/interface').IsMinuteDisabled | undefined
  >
  isStartSecondDisabledRef: import('vue').ComputedRef<
    import('../../time-picker/src/interface').IsSecondDisabled | undefined
  >
  isEndSecondDisabledRef: import('vue').ComputedRef<
    import('../../time-picker/src/interface').IsSecondDisabled | undefined
  >
}
