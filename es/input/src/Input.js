  ...
  setup(props) {
    ...
    watchEffect(() => {
      ...
      if (autosize && type === 'textarea') {
        ...
        stopWatchMergedValue1 === null || stopWatchMergedValue1 === void 0
          ? void 0
    ...
    watchEffect(() => {
      if (props.type === 'textarea') {
        ...
        stopWatchMergedValue2 === null || stopWatchMergedValue2 === void 0
          ? void 0
              ...
              ? h('div', { class: `${mergedClsPrefix}-input__suffix` }, [
                  ...
                  this.showCount && this.type !== 'textarea'
                    ? h(WordCount, null, {
                        default: (props) => {
                          var _a
                          return (_a = $slots.count) === null || _a === void 0
                            ? void 0
                            : _a.call($slots, props)
                        }
                      })
                  ...
                  this.clearable &&
                    h(
                      ...
                      },
                      {
                        default: () => {
                          var _a
                          return (_a = $slots.clear) === null || _a === void 0
                            ? void 0
                            : _a.call($slots)
                        }
                      }
