...
export declare type CalendarThemeVars = ReturnType<typeof self>
declare const calendarLight: import('../../_mixins').Theme<
  'Calendar',
  {
    borderRadius: string
    borderColor: string
...
export declare type CalendarTheme = typeof calendarLight
