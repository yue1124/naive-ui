...
export declare type CreateRowClassName<T = InternalRowData> = (
  row: T,
  index: number
) => string
export declare type CreateRowProps<T = InternalRowData> = (
  row: T,
  index: number
) => HTMLAttributes
export declare type CreateCellProps<T = InternalRowData> = (
  row: T,
  index: number
) => HTMLAttributes
export declare type CompareFn<T = InternalRowData> = (
  row1: T,
  row2: T
) => number
export declare type Sorter<T = InternalRowData> =
  | CompareFn<T>
  | SorterMultiple<T>
...
export declare type Filter<T = InternalRowData> = (
...
export declare type TableExpandColumnTitle =
  | string
  | ((column: TableExpandColumn) => VNodeChild)
export declare type TableColumnGroupTitle =
  | string
...
export declare type RenderExpand<T = InternalRowData> = (
  row: T,
  index: number
) => VNodeChild
export declare type Expandable<T = InternalRowData> = (
  row: T,
  index: number
) => boolean
...
export declare type TableColumn<T = InternalRowData> =
  | TableColumnGroup<T>
  | TableBaseColumn<T>
  | TableSelectionColumn<T>
  | TableExpandColumn<T>
export declare type TableColumns<T = InternalRowData> = Array<TableColumn<T>>
export declare type DataTableSelectionOptions = Array<
...
export declare type RenderSorter = (props: { order: SortOrder }) => VNodeChild
...
export declare type OnUpdateSorter = (
  sortState: SortState & SortState[] & null
) => void
export declare type OnUpdateSorterImpl = (
  sortState: SortState | SortState[] | null
) => void
export declare type OnUpdateFilters = (
...
export declare type OnFilterMenuChange = <
  T extends FilterOptionValue[] & (FilterOptionValue | null)
>(
  value: T
) => void
export declare type OnFilterMenuChangeImpl = (
...
export declare type CreateSummary<T = InternalRowData> = (
  pageData: T[]
