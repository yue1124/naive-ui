...
declare const _default: import('vue').DefineComponent<
  ...
  },
  {
    ...
    summary: import('vue').Ref<
      | import('../interface').CreateSummary<
    ...
    rawPaginatedData: import('vue').Ref<
      import('../interface').InternalRowData[]
    >
    fixedColumnLeftMap: import('vue').Ref<
      Record<
        ColumnKey,
        | {
            start: number
      ...
      >
    >
    fixedColumnRightMap: import('vue').Ref<
      Record<
        ColumnKey,
        | {
            start: number
    ...
    rowClassName: import('vue').Ref<
      | string
      | import('../interface').CreateRowClassName<
          import('../interface').InternalRowData
        >
      | undefined
    >
    renderExpand: import('vue').Ref<
      | import('../interface').RenderExpand<
          import('../interface').InternalRowData
        >
      | undefined
    >
    ...
    firstContentfulColIndex: import('vue').Ref<number>
    indent: import('vue').Ref<number>
    rowProps: import('vue').Ref<
      | import('../interface').CreateRowProps<
          import('../interface').InternalRowData
        >
      | undefined
    >
