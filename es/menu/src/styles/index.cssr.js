...
export default c([cB('menu', `
 ...
 `, [c('a', 'color: var(--n-item-text-color-active-hover-horizontal);'), cE('extra', 'color: var(--n-item-text-color-active-hover-horizontal);')])])]), hoverStyle('border-bottom: 2px solid var(--n-border-color-horizontal);', [cE('icon', `
 ...
 `), cE('extra', `
 color: var(--n-item-text-color-hover-horizontal);
 `)])])]), cB('menu-item-content-header', [c('a', 'color: var(--n-item-text-color-horizontal);')])])]), cM('collapsed', [cB('menu-item', [cM('selected', [c('&::before', `
 ...
 `, [c('a', 'color: var(--n-item-text-color-active-hover);'), cE('extra', 'color: var(--n-item-text-color-active-hover);')])])]), cM('selected', [hoverStyle(null, [c('&::before', 'background-color: var(--n-item-color-active-hover);')])]), hoverStyle(null, [c('&::before', 'background-color: var(--n-item-color-hover);'), cE('arrow', `
