...
export function formItemSize(props) {
  ...
  return {
    mergedSize: computed(() => {
      ...
      if (
        (NForm === null || NForm === void 0 ? void 0 : NForm.props.size) !==
        undefined
      )
...
export function formItemMisc(props) {
  ...
  const mergedLabelWidthRef = computed(() => {
    ...
    if (
      labelWidth === 'auto' ||
      (NForm === null || NForm === void 0 ? void 0 : NForm.props.labelWidth) ===
        'auto'
    ) {
  ...
  const mergedLabelPlacementRef = computed(() => {
    ...
    if (
      NForm === null || NForm === void 0 ? void 0 : NForm.props.labelPlacement
    )
  ...
  const mergedShowFeedbackRef = computed(() => {
    ...
    if (
      (NForm === null || NForm === void 0
        ? void 0
        : NForm.props.showFeedback) !== undefined
    )
  ...
  const mergedShowLabelRef = computed(() => {
    ...
    if (
      (NForm === null || NForm === void 0 ? void 0 : NForm.props.showLabel) !==
      undefined
    )
