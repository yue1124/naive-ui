...
exports.default = (0, vue_1.defineComponent)({
    ...
    setup(props) {
        ...
        const { themeRef } = (0, vue_1.inject)(context_1.colorPickerInjectionKey, null);
        (0, vue_1.watchEffect)(() => {
    ...
    render() {
        ...
        return ((0, vue_1.h)(input_1.NInput, { size: "small", placeholder: this.label, theme: mergedTheme.peers.Input, themeOverrides: mergedTheme.peerOverrides.Input, builtinThemeOverrides: inputThemeOverrides, value: this.inputValue, onUpdateValue: this.handleInputUpdateValue, onChange: this.handleInputChange, 
