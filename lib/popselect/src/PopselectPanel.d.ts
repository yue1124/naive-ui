...
export declare const panelPropKeys: ("value" | "size" | "multiple" | "onChange" | "onMouseenter" | "onMouseleave" | "options" | "scrollable" | "renderLabel" | "onUpdate:value" | "onUpdateValue" | "cancelable")[];
