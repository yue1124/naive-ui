...
exports.default = (0, vue_1.defineComponent)({
    ...
    setup(props) {
        ...
        const displayTimeStringRef = (0, vue_1.ref)(mergedValue === null
            ? ''
            : (0, date_fns_1.format)(mergedValue, props.format, dateFnsOptionsRef.value));
        ...
        const memorizedValueRef = (0, vue_1.ref)(mergedValue);
        ...
        const hourValueRef = (0, vue_1.computed)(() => {
            ...
            if (value === null)
                return null;
            return Number((0, date_fns_1.format)(value, 'HH', dateFnsOptionsRef.value));
        });
        const minuteValueRef = (0, vue_1.computed)(() => {
            const { value } = mergedValueRef;
            if (value === null)
                return null;
            return Number((0, date_fns_1.format)(value, 'mm', dateFnsOptionsRef.value));
        });
        const secondValueRef = (0, vue_1.computed)(() => {
            const { value } = mergedValueRef;
            if (value === null)
                return null;
            return Number((0, date_fns_1.format)(value, 'ss', dateFnsOptionsRef.value));
        });
        ...
        function doUpdateValue(value) {
            ...
            const formattedValue = value === null ? null : (0, date_fns_1.format)(value, props.valueFormat || props.format);
            if (onUpdateValue) {
        ...
        function deriveInputValue(time) {
            ...
            if (time === null)
                ...
                displayTimeStringRef.value = (0, date_fns_1.format)(time, props.format, dateFnsOptionsRef.value);
            }
        }
