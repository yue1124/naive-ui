...
exports.exposedDialogEnvProps = Object.assign(Object.assign({}, dialogProps_1.dialogProps), { closeOnEsc: { type: Boolean, default: true }, internalStyle: [String, Object], maskClosable: {
        type: Boolean,
        default: true
...
exports.NDialogEnvironment = (0, vue_1.defineComponent)({
    ...
    render() {
        ...
        return ((0, vue_1.h)(Modal_1.default, { show: show, onUpdateShow: handleUpdateShow, onMaskClick: handleMaskClick, to: to, maskClosable: maskClosable, onAfterLeave: handleAfterLeave, closeOnEsc: this.closeOnEsc, internalAppear: true, internalDialog: true }, {
