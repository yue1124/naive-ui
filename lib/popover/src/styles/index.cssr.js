...
(0, cssr_1.c)('&.popover-transition-enter-from, &.popover-transition-leave-to', `
 ...
 `, [(0, cssr_1.cNotM)('show-header', 'padding: var(--n-padding);')]), (0, cssr_1.cE)('header', `
...
function placementStyle(placement, arrowStyleLiteral) {
  ...
  return (0, cssr_1.c)(`[v-placement="${placement}"] >`, [(0, cssr_1.cB)('popover', [(0, cssr_1.cNotM)('manual-trigger', `
