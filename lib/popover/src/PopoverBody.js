...
exports.popoverBodyProps = Object.assign(Object.assign({}, _mixins_1.useTheme.props), { to: _utils_1.useAdjustedTo.propTo, show: Boolean, trigger: String, showArrow: Boolean, delay: Number, duration: Number, raw: Boolean, arrowPointToCenter: Boolean, arrowStyle: [String, Object], displayDirective: String, x: Number, y: Number, flip: Boolean, overlap: Boolean, placement: String, width: [Number, String], keepAliveOnHover: Boolean, internalTrapFocus: Boolean, 
    // private
        ...
        function renderContentNode() {
            ...
            if (!renderBody) {
                ...
                const renderContentInnerNode = () => {
                    var _a;
                    return [
                        (0, _utils_1.resolveWrappedSlot)(slots.header, (children) => children && [
                            (0, vue_1.h)("div", { class: `${mergedClsPrefix}-popover__header` }, children),
                            (0, vue_1.h)("div", { class: `${mergedClsPrefix}-popover__content` }, slots)
