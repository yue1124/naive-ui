...
const dynamicInputProps = Object.assign(Object.assign({}, _mixins_1.useTheme.props), { max: Number, min: {
        type: Number,
        default: 0
    }, value: Array, 
...
exports.default = (0, vue_1.defineComponent)({
    ...
    setup(props, { slots }) {
        ...
        const { mergedComponentPropsRef, mergedClsPrefixRef, mergedRtlRef, inlineThemeDisabled } = (0, _mixins_1.useConfig)();
        ...
        const rtlEnabledRef = (0, use_rtl_1.default)('DynamicInput', mergedRtlRef, mergedClsPrefixRef);
    ...
    render() {
        ...
        return ((0, vue_1.h)("div", { class: [
            ...
            (0, vue_1.h)("div", { class: `${mergedClsPrefix}-dynamic-input-item__action` },
                (0, vue_1.h)(button_group_1.NButtonGroup, { size: buttonSize }, {
                    default: () => [
