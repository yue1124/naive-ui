...
function useTableData(props, { dataRelatedColsRef }) {
    ...
    const firstContentfulColIndexRef = (0, vooks_1.useMemo)(() => {
        const { columns } = props;
    ...
    const mergedCurrentPageRef = (0, vooks_1.useMergedState)(controlledCurrentPageRef, uncontrolledCurrentPageRef);
