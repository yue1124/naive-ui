        ...
        if (this.hasLoadError) {
            ...
            img = (0, _utils_1.resolveWrappedSlot)($slots.default, (children) => {
                if (children) {
                    ...
                    return ((0, vue_1.h)("img", { src: src, onError: this.handleError, style: { objectFit: this.objectFit } }));
                }
            });
        }
        return ((0, vue_1.h)("span", { ref: "selfRef", class: [`${mergedClsPrefix}-avatar`, this.themeClass], style: this.cssVars }, img));
    }
});
