...
const blockQuoteRenderer = {
  render(node, options, children) {
    return (0, vue_1.h)(
      (0, vue_1.h)(typography_1.NBlockquote, null, () => children)
    )
  }
}
const codeRenderer = {
  render(node, options) {
    if (options.inlinecode === 'text') {
      return (0, vue_1.h)(
        (0, vue_1.h)(typography_1.NText, { code: true }, () => node.literal)
      )
    } else {
      return (0, vue_1.h)(
        (0, vue_1.h)(code_1.NCode, {
...
const emphRenderer = {
  render(node, options, children) {
    switch (options.emph) {
      ...
      case 'naive':
        return (0, vue_1.h)(
          (0, vue_1.h)(typography_1.NText, { italic: true }, () => children)
        )
    }
  }
}
const headingRenderer = {
  render(node, options, children) {
    switch (node.level) {
      case 1:
        return (0, vue_1.h)(
          (0, vue_1.h)(typography_1.NH1, null, () => children)
        )
      case 2:
        return (0, vue_1.h)(
          (0, vue_1.h)(typography_1.NH2, null, () => children)
        )
      case 3:
        return (0, vue_1.h)(
          (0, vue_1.h)(typography_1.NH3, null, () => children)
        )
      case 4:
        return (0, vue_1.h)(
          (0, vue_1.h)(typography_1.NH4, null, () => children)
        )
      case 5:
        return (0, vue_1.h)(
          (0, vue_1.h)(typography_1.NH5, null, () => children)
        )
      case 6:
        return (0, vue_1.h)(
          (0, vue_1.h)(typography_1.NH6, null, () => children)
        )
    }
  }
}
...
const imageRenderer = {
  render(node, options, children) {
    ...
    if (src === null || src.length === 0) {
      return (0, vue_1.h)((0, vue_1.h)('div', null, '![', alt, ']()'))
    } else {
      if (
      ...
      return (0, vue_1.h)(
        (0, vue_1.h)('img', { src: src, alt: alt, title: node.title || alt })
      )
    }
  }
}
...
const linkRenderer = {
  render(node, options, children) {
    ...
    return (0, vue_1.h)(
      typography_1.NA,
      { href: node.destination, title: node.title },
      () => title
    )
  }
}
const listRenderer = {
  render(node, options, children) {
    switch (node.listType) {
      case 'bullet':
        return (0, vue_1.h)(
          (0, vue_1.h)(typography_1.NUl, null, () => children)
        )
      case 'ordered':
        return (0, vue_1.h)(
          (0, vue_1.h)(typography_1.NOl, null, () => children)
        )
    }
  }
}
...
const strongRenderer = {
  render(node, options, children) {
    switch (options.strong) {
      ...
      case 'naive':
        return (0, vue_1.h)(
          (0, vue_1.h)(typography_1.NText, { strong: true }, () => children)
        )
    }
  }
}
