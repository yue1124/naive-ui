...
exports.default = (0, cssr_1.c)([(0, cssr_1.cB)('menu', `
 ...
 `)]), (0, cssr_1.cNotM)('disabled', [(0, cssr_1.cM)('selected, child-active', [hoverStyle(null, [(0, cssr_1.cE)('icon', 'color: var(--n-item-icon-color-active-hover-horizontal);'), (0, cssr_1.cB)('menu-item-content-header', `
 color: var(--n-item-text-color-active-hover-horizontal);
 `, [(0, cssr_1.c)('a', 'color: var(--n-item-text-color-active-hover-horizontal);'), (0, cssr_1.cE)('extra', 'color: var(--n-item-text-color-active-hover-horizontal);')])])]), hoverStyle('border-bottom: 2px solid var(--n-border-color-horizontal);', [(0, cssr_1.cE)('icon', `
 ...
 `), (0, cssr_1.cE)('extra', `
 color: var(--n-item-text-color-hover-horizontal);
 `)])])]), (0, cssr_1.cB)('menu-item-content-header', [(0, cssr_1.c)('a', 'color: var(--n-item-text-color-horizontal);')])])]), (0, cssr_1.cM)('collapsed', [(0, cssr_1.cB)('menu-item', [(0, cssr_1.cM)('selected', [(0, cssr_1.c)('&::before', `
 background-color: var(--n-item-color-active-collapsed) !important;
 `)])]), (0, cssr_1.cB)('menu-item-content', [(0, cssr_1.cB)('menu-item-content-header', 'opacity: 0;'), (0, cssr_1.cE)('arrow', 'opacity: 0;'), (0, cssr_1.cE)('icon', 'color: var(--n-item-icon-color-collapsed);')])]), (0, cssr_1.cB)('menu-item', `
 ...
 `)]), (0, cssr_1.cNotM)('disabled', [(0, cssr_1.cM)('selected, child-active', [hoverStyle(null, [(0, cssr_1.cE)('arrow', 'color: var(--n-arrow-color-active-hover);'), (0, cssr_1.cE)('icon', 'color: var(--n-item-icon-color-active-hover);'), (0, cssr_1.cB)('menu-item-content-header', `
 color: var(--n-item-text-color-active-hover);
 `, [(0, cssr_1.c)('a', 'color: var(--n-item-text-color-active-hover);'), (0, cssr_1.cE)('extra', 'color: var(--n-item-text-color-active-hover);')])])]), (0, cssr_1.cM)('selected', [hoverStyle(null, [(0, cssr_1.c)('&::before', 'background-color: var(--n-item-color-active-hover);')])]), hoverStyle(null, [(0, cssr_1.c)('&::before', 'background-color: var(--n-item-color-hover);'), (0, cssr_1.cE)('arrow', `
