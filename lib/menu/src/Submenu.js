...
exports.NSubmenu = (0, vue_1.defineComponent)({
    ...
    render() {
        ...
        return this.root ? ((0, vue_1.h)(dropdown_1.NDropdown, Object.assign({}, (_a = this.menuProps) === null || _a === void 0 ? void 0 : _a.dropdownProps, { themeOverrides: this.mergedTheme.peerOverrides.Dropdown, theme: this.mergedTheme.peers.Dropdown, builtinThemeOverrides: {
                fontSizeLarge: '14px',
