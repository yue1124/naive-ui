...
exports.default = (0, vue_1.defineComponent)({
    ...
    props: Object.assign(Object.assign({}, _mixins_1.useTheme.props), { clsPrefix: {
        ...
        show: {
            type: Boolean,
            default: true
        }, loading: Boolean, focusable: Boolean, renderLabel: Function, renderOption: Function, onMousedown: Function, onScroll: Function, onFocus: Function, onBlur: Function, onKeyup: Function, onKeydown: Function, onTabOut: Function, onMouseenter: Function, onMouseleave: Function, onResize: Function, resetMenuOnOptionsChange: {
            type: Boolean,
            default: true
    ...
    setup(props) {
        ...
        (0, vue_1.watch)((0, vue_1.toRef)(props, 'show'), (value) => {
            if (value) {
                initPendingNodeWatchStopHandle = (0, vue_1.watch)(props.resetMenuOnOptionsChange
                    ? [(0, vue_1.toRef)(props, 'treeMate'), (0, vue_1.toRef)(props, 'multiple')]
                    : [(0, vue_1.toRef)(props, 'multiple')], () => {
                    initPendingNode();
