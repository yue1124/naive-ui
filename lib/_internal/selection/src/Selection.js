...
exports.default = (0, vue_1.defineComponent)({
    ...
    render() {
        ...
        if (multiple) {
            ...
            })) : ((0, vue_1.h)(tag_1.NTag, { size: size, closable: !option.disabled, disabled: disabled, internalStopClickPropagation: true, onClose: () => this.handleDeleteOption(option) }, {
                default: () => renderLabel
            ...
            if (filterable) {
                ...
                const popoverTrigger = ((0, vue_1.h)("div", { ref: "multipleElRef", class: `${clsPrefix}-base-selection-tags`, tabindex: disabled ? undefined : 0 },
                    ...
                    suffix));
                body = ((0, vue_1.h)(vue_1.Fragment, null,
                    useMaxTagCount ? ((0, vue_1.h)(popover_1.NPopover, Object.assign({}, popoverProps, { scrollable: true, style: "height: calc(var(--v-target-height) * 6.6);" }), {
                        trigger: () => popoverTrigger,
                        default: renderPopover
                    })) : (popoverTrigger),
                    placeholder));
